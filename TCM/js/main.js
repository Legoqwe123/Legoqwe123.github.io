$(function() {
   ...
   $('.menu-btn').on('click', function () {  // Открываем меню 
 
      $('.modal-burger').show(500)
   });

   $('.modal-close__btn').on('click', function () { //  закрываем  меню
      $('.modal-burger').hide(500)
  });

  
  $('.modal-message__button').on('click', function () { //  закрываем блок успешной отправки сообщения на сервер
